@extends('layouts.app')
@extends('orders.layout.sidebar',['stage_name' =>'Order Filling'])
...
<div class="tab-pane fade show active order-outer" id="orderReception">
    ...
    <div class="d-flex mb-3 back-btn">
        ...
        <div clas=""><span ><a href="{{ URL('/filling') }}">Back</a></span></div>
    </div>
    <div class="">
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="order-button custom-scrollbar-css">
                        <div class="row">
                            <div class="col-sm-6">        
                                <form class="mb-3 select-state" name="decline_change_stage" method="post" action="{{ url('/filling/changeorderstate/'.$pdf_detail['order_id']) }}">
                                    @csrf
                            ...
                            <div class="col-sm-6" align="right">
                                <form class="mb-3 select-state" name="change_stage" method="post" action="{{ url('/filling/changeorderstate/'.$pdf_detail['rx_details'][0]['order_id']) }}">
                                    @csrf
                                    <input type="hidden" name="change_state" value="6">
                                    <input type="hidden" name="order_id" value="{{ $pdf_detail['rx_details'][0]['order_id'] }}">
                                            ...
                                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                                <div class="card card-body rx-panel">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <b>Daw: </b>{{ isset($pdf_detail['rx_details'][0]['daw']['description']) ? $pdf_detail['rx_details'][0]['daw']['description'] : '' }}
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <form method="post" action="{{ url('dispatch/save') }}" class="add-new-form">
                                                    ...
                                                    <input type="hidden" name="redirect_to" id="redirect_to" value='filling'/>
                                                    ...
                                                    <div class="modal-footer">
                                                        <input type="submit" class="btn purple-btn btn-sm" name="" id="" value="Save">
                                                    </div>   
                                                </form>
                                            </div>
                                        </div> <!-- ./Dispatch --> 
