...
<div class="tab-pane fade show active order-outer" id="orderReception">
    ...
    <div class="d-flex mb-3 back-btn">
        ...
        <div clas=""><span ><a href="{{ URL('/verification') }}">Back</a></span></div>
    </div>
    <div class="">
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="order-button custom-scrollbar-css">
                        <div class="row">
                            <div class="col-sm-6">        
                                <form class="mb-3 select-state" name="decline_change_stage" id="decline_change_stage" method="post" action="{{ url('/verification/changeorderstate/'.$pdf_detail['order_id']) }}">
                                    @csrf
                            ...
                            <div class="col-sm-6" align="right">
                                <form class="mb-3 select-state" name="change_stage" method="post" action="{{ url('/verification/changeorderstate/'.$pdf_detail['rx_details'][0]['order_id']) }}">
                                    @csrf
                                    <input type="hidden" name="change_state" value="7">
                                    ...
                                    <button class="btn purple-btn btn-sm" id="scan_approval" <?php if(!in_array(Auth()->user()->role, [1, 2])) { echo "disabled"; }?> title="<?php if(!in_array(Auth()->user()->role, [1, 2])) { echo trans('messages.no_approve_permission'); }?>">Approve</button>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row rx-row">
                            ...
                            <div class="col"><b>LOG ID/NDC:</b><br/>
                                {{ $pdf_detail['rx_details'][0]['log_id'] ? $pdf_detail['rx_details'][0]['log_id'] : ''}} 
                            </div>
                            @endif
                        </div>
                        <div class="row rx-row">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    ...
                                                    <form method="post" action="{{ url('dispatch/save') }}" class="add-new-form">
                                                        ...
                                                        <input type="submit" class="btn purple-btn btn-sm" name="save" id="" value="Save">    
                                                    </form>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            @if(!empty($pdf_detail['rx_details'][0]['rx_id']) && !empty($pdf_detail['rx_details'][0]['log_id']))
                                                            <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                <input type="hidden"  class="form-control" name="scan_log_url" id="scan_log_url" value="{{ url('scannedlog') }}">
                                                                <input type="text"  class="form-control" name="scan_log" id="scan_log" placeholder="Scan LOG ID" onfocusout="getScanLogDetails(this.value,{{$pdf_detail['rx_details'][0]['log_id']}}, {{$pdf_detail['rx_details'][0]['formula']}})">
                                                            </div>
                                                            <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                <input type="hidden"  class="form-control" name="scan_rx_url" id="scan_rx_url" value="{{ url('scannedrx') }}">
                                                                <input type="text"  class="form-control" name="scan_rx" id="scan_rx" placeholder="Scan Rx#" onfocusout="getScanRxDetails(this.value,{{$pdf_detail['rx_details'][0]['rx_id']}})">
                                                            </div>
                                                           @endif
                                                        </div>
                                                    </div>
