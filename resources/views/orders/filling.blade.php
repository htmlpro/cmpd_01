...
@endsection
@section('content')
@include('orders.layout.counter_nav', ['stage' => '4'])
    ...
    <div class="grid-outer">
        ...
        <table id="pharmacy_tabel" class="display" style="width:100%;display: none;font-size:11px;">
            ...
            <tbody>
                ...
                <tr ondblclick="openStageWindow({{ '"filling"'.','.$val['order_id'].','.$val['rx_id'] }})"> 
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                ...
                                <input type="hidden" name="current_stage" id="current_stage" value="4"/> 
                                ...
                                <a class="dropdown-item" href="{{ url('/filling/changeorderstate/'.$val['rx_id'].'/'.$val['order_id'].'/6') }}">Change Stage</a>
                                <a class="dropdown-item" href="{{ url('/order/manage/filling/'.$val['order_id'].'/'.$val['rx_id']) }}">Manage</a>
                            </div>
                        </div>
                    </td>  
                </tr>
